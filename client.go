...
func NewClient(ctx context.Context, corp, model, key, baseURL, path string, isSupportSystemRole, isSupportStream *bool, proxyURL ...string) Client {
	...
	case consts.CORP_OPENAI:
		return openai.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_AZURE:
		return openai.NewAzureClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_BAIDU:
		return baidu.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_XFYUN:
		return xfyun.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_ALIYUN:
		return aliyun.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_ZHIPUAI:
		return zhipuai.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_GOOGLE:
		return google.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_GCP_GEMINI:
		return google.NewGcpClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_DEEPSEEK:
		return deepseek.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_DEEPSEEK_BAIDU:
		return deepseek.NewClientBaidu(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_360AI:
		return ai360.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_ANTHROPIC:
		return anthropic.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_GCP_CLAUDE:
		return anthropic.NewGcpClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_AWS_CLAUDE:
		return anthropic.NewAwsClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	case consts.CORP_VOLC_ENGINE:
		return volcengine.NewClient(ctx, model, key, baseURL, path, isSupportSystemRole, isSupportStream, proxyURL...)
	}
